...
<td style="padding-left: 20px;"><a target="_blank" href="/blog/index.php?m=Home&c=index&a=category&id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a></td>
<td align="center">
<?php if($vo['type'] == 1): ?>文章<?php endif; ?>
<?php if($vo['type'] == 2): ?>产品<?php endif; ?>
</td>
<td align="center"><?php if($vo['pic'] != ''): ?><img src="/blog/Uploads<?php echo ($vo["pic"]); ?>" height="30"><?php else: ?>暂无图片<?php endif; ?></td>
...
<td style="padding-left: 20px;">———— <a target="_blank" href="/blog/index.php?m=Home&c=index&a=category&id=<?php echo ($vs["id"]); ?>"><?php echo ($vs["name"]); ?></a></td>
<td align="center">
<?php if($vs['type'] == 1): ?>文章<?php endif; ?>
<?php if($vs['type'] == 2): ?>产品<?php endif; ?>
</td>
<td align="center"><?php if($vs['pic'] != ''): ?><img src="/blog/Uploads<?php echo ($vs["pic"]); ?>" height="30"><?php else: ?>暂无图片<?php endif; ?></td>
