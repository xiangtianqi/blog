...
<script src="/blog/Public/js/jquery-1.4.2.min.js"></script>
<div class="aright">
...
<form class="layui-form" action="/blog/admin.php?m=Admin&c=article&a=index" method="post">
...
<table width="100%">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td align="center"><a target="_blank" href="/blog/index.php?m=Home&c=index&a=article&id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
		<td align="center">
		<?php if($vo[pic] != ''): ?><img src="/blog/Uploads<?php echo ($vo["pic"]); ?>" height="30">
        <?php else: ?> 
        暂无缩略图<?php endif; ?>
		</td>
