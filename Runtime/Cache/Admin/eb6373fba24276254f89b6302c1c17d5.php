...
<form class="layui-form bform" method="post" action="<?php echo U('banner/doedit');?>" enctype="multipart/form-data">
   ...
   <div class="layui-form-item">
    <label class="layui-form-label">幻灯图1</label>
     ...
     <input class="file-txt" type="text" autocomplete="off" name="textfield" id="textfield"><?php if($b[apic] != ''): ?><img src="/blog/Uploads<?php echo ($b["apic"]); ?>" height="50"><?php else: endif; ?>
   ...
   <div class="layui-form-item">
    <label class="layui-form-label">幻灯图2</label>
     ...
     <i class="layui-icon">&#xe61f;</i>
     <input class="file-btn" type="button" value="选择图片"> 
     <input class="file-txt" type="text" autocomplete="off" name="textfieldb" id="textfieldb"><?php if($b[bpic] != ''): ?><img src="/blog/Uploads<?php echo ($b["bpic"]); ?>" height="50"><?php else: endif; ?>
   ...
   <div class="layui-form-item">
    <label class="layui-form-label">幻灯图3</label>
     ...
     <i class="layui-icon">&#xe61f;</i>
     <input class="file-btn" type="button" value="选择图片"> 
     <input class="file-txt" type="text" autocomplete="off" name="textfieldc" id="textfieldc"><?php if($b[cpic] != ''): ?><img src="/blog/Uploads<?php echo ($b["cpic"]); ?>" height="50"><?php else: endif; ?>
